package com.game_2048.GameModel;
...
import com.game_2048.Activity.HistoryActivity;
import com.game_2048.Activity.MenuActivity;
import com.game_2048.Model.Card;
import com.game_2048.Model.CardLayout;
import com.game_2048.Model.Player;
import com.game_2048.R;
import com.game_2048.util.DialogToOver;
import com.game_2048.util.MyTimer;
...
//                intent.putExtra("Cards", (Serializable) cardLayout.getCards());
    ...
    private double addSec(long add) {
        ...
        if (add != 0) {
            Toast toast = Toast.makeText(this, "增加时间" + String.format("%.3f", a > 7 ? 7 : a) + "秒", Toast.LENGTH_SHORT);
